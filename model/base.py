...
class BaseModel(nn.Module):
    ...
    def _initialize_models(self, args, device):
        ...
        self.real_score = WanDiffusionWrapper(model_name=self.real_model_name, **getattr(args, "model_kwargs", {}), is_causal=False)
        self.real_score.model.requires_grad_(False)

        self.fake_score = WanDiffusionWrapper(model_name=self.fake_model_name, **getattr(args, "model_kwargs", {}), is_causal=False)
