import gc
import logging
from utils.dataset import ODERegressionLMDBDataset, ShardingLMDBDataset, cycle
        ...
        while True:
            ...
            if max_iters is not None and self.step >= max_iters:
                if self.is_main_process:
                    ...
                    print(f"Final checkpoint saved at step {self.step - (self.step % self.config.log_iters)}")
                    print(f"{'='*80}\n")
                break
