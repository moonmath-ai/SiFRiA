...
(karthik)
The code expects Wan models to be located in `/data/models/wan_models/`. If you need to download them:
```
huggingface-cli download Wan-AI/Wan2.1-T2V-1.3B --local-dir-use-symlinks False --local-dir /data/models/wan_models/Wan2.1-T2V-1.3B
